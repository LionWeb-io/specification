...
Each Metamodel will contain a list of <<MetamodelElement, Metamodel elements>> in `elements` containment.
...
A Concept has a reference <<container, `container`>> to the containing <<NamespaceProvider>>.
...
A ConceptInterface has a reference <<container, `container`>> to the containing <<NamespaceProvider>>.
...
A MetamodelElement has a reference <<container, `container`>> to the containing <<NamespaceProvider>>.
...
A Containment has a reference <<container, `container`>> to the containing <<NamespaceProvider>>.
...
A Reference has a reference <<container, `container`>> to the containing <<NamespaceProvider>>.
It can be marked as <<optional, `optional`>> and <<multiple, `multiple`>>.
...
A Property has a reference <<container, `container`>> to the containing <<NamespaceProvider>>.
...
A FeaturesContainer has a reference <<container, `container`>> to the containing <<NamespaceProvider>>.
...
A FeaturesContainer is a <<MetamodelElement>>.
It is a <<NamespaceProvider>> and indirectly a <<NamespacedEntity>>.
...
A DataType has a reference <<container, `container`>> to the containing <<NamespaceProvider>>.
...
A Feature has a reference <<container, `container`>> to the containing <<NamespaceProvider>>.
...
A Link has a reference <<container, `container`>> to the containing <<NamespaceProvider>>.
It can be marked as <<optional, `optional`>>.
