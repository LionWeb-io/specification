...
Assuming an implementation in an object-oriented language like Java, something went wrong if we had two different Java objects of class `Node`, but with equal `nodeId` field.
