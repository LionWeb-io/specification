...
The name is for humans to understand the property; we use the key to uniquely identify the property technically.
...
plantuml::../metametamodel/builtins.puml[format=svg]
