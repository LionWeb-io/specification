...
Each <<{m3}.adoc#Field, Field>> forms one _member_, with the field's <<{m3}.adoc#IKeyed.key, key>> as JSON _key_ and the field's value as JSON _value_.
...
For fields of type <<structuredDatatype>>, the value is encoded as JSON _object_ if the field is set, otherwise as JSON _null_.
...
structured datatype Amount             [id 10, key amount]
  ...
  currency: String                     [id 12, key amount-cur]
...
structured datatype ComplexNumber      [id 30, key compex]
  real: Decimal                        [id 31, key complex-real]
  imaginary: Decimal                   [id 32, key complex-imaginary]

structured datatype FullyQualifiedName [id 50, key fqn]
  name: String                         [id 40, key nm]
  nested: FullyQualifiedName           [id 55, key nested]
----
--
...
* FullyQualifiedName _com.example.subdomain_: `"{\n  \"nm\": \"com\",\n  \"nested\": {\n    \"nm\": \"example\",\n    \"nested\": {\n      \"nm\": \"subdomain\",\n      \"nested\": null\n    }\n  }\n}"`
+
unescaped content:
+
[source, json]
...
* Decimal with `null` value for field with primitive type: `"{\"decimal-int\": \"42\", \"decimal-frac\": null}"`
+
unescaped content:
+
[source, json]
...
* FullyQualifiedName with _null_ as string value for unset nested structured datatype: `"{\n  \"nm\": \"com\",\n  \"nested\": {\n    \"nm\": \"example\",\n    \"nested\": {\n      \"nm\": \"subdomain\",\n      \"nested\": \"null\"\n    }\n  }\n}"`
+
unescaped content:
+
[source, json]
