...
In this document we describe the Meta-Metamodel to be used by LionWeb *version 2026.1*.
...
[[INamed, INamed]]
[[INamed.name]]
* `INamed`{fn-org86}, an <<Interface>> with one <<Property>> called `name` of type <<String>>.
+
