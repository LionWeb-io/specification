...
[[additionalInfosType]]additionalInfo:: Optionally empty{fn-org402} list of [[Response.additionalInfos]] _additional infos_ in either request or response.{fn-org236}{fn-org375}{fn-org430}
Each additional info MUST have the following properties:
...
A client or repository MAY reply with other, additional kinds.

* [[additionalInfo.message]]`message` is a human-readable string describing the additional info.

* [[additionalInfo.data]]`data` is a flat map with arbitrary keys and values.
