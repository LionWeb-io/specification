...
* Parameters suffixed with `[]` are ordered lists with at least one entry.
...
[[messagesType]]message:: Optionally empty{fn-org402} list of [[Response.messages]] messages in either request or response.{fn-org236}{fn-org375}
