...
#TODO: Clarify we never sent partial nodes#
...
Containment needs to be sent from the parent's view, because containments are part of a list (with index).

#TODO: Add delete command, Q: Do we update references to that node?#
