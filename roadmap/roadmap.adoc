...
[[in-progress]]
=== In progress for _after_ version 2024.1
...
Derived models may be persisted or be recalculated on the fly.footnote:[https://github.com/LionWeb-io/specification/issues?q=is%3Aissue+label%3Aderived[issues on derived models]]
