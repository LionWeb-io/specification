...
clientQuery -> repoQuery ++: signOn("repo-alpha", "2026.1", "myClient")
...
1. Client <<qry-SignOn, signs on>> to repository `repo-alpha`, with protocol version `2026.1`, and client id `myClient`.
