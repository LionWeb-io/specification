...
include::references/MoveEntryFromOtherReference/MoveEntryFromOtherReference-diagram.adoc[]
...
include::references/MoveEntryFromOtherReferenceInSameParent/MoveEntryFromOtherReferenceInSameParent-diagram.adoc[]
...
include::references/MoveEntryInSameReference/MoveEntryInSameReference-diagram.adoc[]
...
include::references/MoveAndReplaceEntryFromOtherReference/MoveAndReplaceEntryFromOtherReference-diagram.adoc[]
...
include::references/MoveAndReplaceEntryFromOtherReferenceInSameParent/MoveAndReplaceEntryFromOtherReferenceInSameParent-diagram.adoc[]
...
include::references/MoveAndReplaceEntryInSameReference/MoveAndReplaceEntryInSameReference-diagram.adoc[]
