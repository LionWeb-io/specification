...
<<existing-nodes, Existing node>> <<ChildMovedFromOtherContainment.movedChild>> (previously inside <<ChildMovedFromOtherContainment.oldParent>>'s <<ChildMovedFromOtherContainment.oldContainment>> at <<ChildMovedFromOtherContainment.oldIndex>>) has been moved
