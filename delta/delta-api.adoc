...
The delta API *version 2026.1* is used to store and retrieve changes to nodes.
...
include::description/description.adoc[]
...
[appendix]
== Delta JSON Schema
The LionWeb link:delta.schema.json[delta JSON Schema].

[source, json]
----
include::delta.schema.json[]
----
