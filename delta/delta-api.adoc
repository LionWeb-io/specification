...
Existing node `movedChild` (previously inside ``oldParent``'s `oldContainment` at `oldIndex`) has replaced the existing node inside ``newParent``'s `newContainment` at `newIndex`.
...
Existing node `movedChild` (previously inside ``parent``'s `oldContainment` at `oldIndex`) has replaced the existing node inside ``parent``'s `newContainment` at `newIndex`.
...
Existing node `movedChild` (previously inside ``parent``'s `containment` at `oldIndex`) has replaced the existing node inside ``parent``'s `containment` at `newIndex`.
...
Existing node `movedAnnotation` (previously inside ``oldParent``'s annotations at `oldIndex`) has replaced the existing annotation inside ``newParent``'s annotations at `newIndex`.
...
Existing node `movedAnnotation` (previously inside ``parent``'s annotations at `oldIndex`) has replaced the existing annotation inside ``parent``'s annotations at `newIndex`.
...
Existing reference `target`/`resolveInfo` (previously inside ``oldParent``'s `oldReference` at `oldIndex`) has replaced existing entry at ``newParent``'s `newReference` at `newIndex`.

All other entries inside ``oldParent``'s `oldReference` with index > `oldIndex` have been moved to next lower index.

No other entries inside ``newParent``'s `newReference` have been changed.
...
Existing reference `target`/`resolveInfo` (previously inside ``parent``'s `oldReference` at `oldIndex`) has replaced existing entry at ``parent``'s `newReference` at `newIndex`.

All other entries inside ``parent``'s `oldReference` with index > `oldIndex` have been moved to next lower index.

No other entries inside ``parent``'s `newReference` have been changed.
...
Existing reference `target`/`resolveInfo` (previously inside ``parent``'s `reference` at `oldIndex`) has replaced existing entry at ``parent``'s `reference` at `newIndex`.
