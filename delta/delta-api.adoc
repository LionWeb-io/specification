...
[cols="a,a,a,a"]
|===
|Name |Request Parameters |Response Parameters |Errors

4+|
[[cmd-subscription]]
==== Subscription

|[[qry-subscribePartitions, subscribe to partition changes query]]*subscribe to partition changes*
...
|[[qry-subscribePartition, subscribe to partition command]]*subscribe to partition*
