...
==== Protocol Message
Each message optionally can have one or more _protocol message_ consisting of:{fn-org331}{fn-org332}{fn-org430}
...
* [[protocolMessage.reach]]`reach` describes who should receive this protocol message.{fn-org421}
