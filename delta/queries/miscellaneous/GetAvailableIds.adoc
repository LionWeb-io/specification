...
[horizontal]
.Request parameters
[[GetAvailableIds.count, `count`]]count:: <<countType>>
Number of ids requested.

[[GetAvailableIds.requestQueryId, `queryId`]]queryId:: <<queryIdType>>
Id of this query.

[[GetAvailableIds.requestAdditionalInfos, `additionalInfos`]]additionalInfos:: <<additionalInfosType>>
...
[[GetAvailableIds.responseAdditionalInfos, `additionalInfos`]]additionalInfos:: <<additionalInfosType>>
Optionally empty list of <<additionalInfo>>s.
